...
class ToggleButtonsSet extends St.Bin {
    _init(gIcon, isSecondSet, dataHandler, params = {}) {
        ...
        const icon4 = isSecondSet ? config.set2Button4Icon : config.set1Button4Icon;
        const button2Styleclass = icon3 ? 'bbm-toggle-button-middle' : 'bbm-toggle-button-end';
        const button3Styleclass = icon4 ? 'bbm-toggle-button-middle' : 'bbm-toggle-button-end';
        ...
        if (icon3) {
            const button3 = new St.Button({
                style_class: `bbm-toggle-button  ${button3Styleclass}`,
            });
        ...
        if (icon4) {
            ...
            button4.child = button4Icon;
            box.add_child(button4);
            button4.connectObject(
                'clicked', () => {
            ...
            this._buttons.push({button: button4, number: 4});
        }
