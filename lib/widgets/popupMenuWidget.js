...
export const PopupMenuWidgetBox = GObject.registerClass({
    ...
    _init(settings, gIcon, path, alias, widgetInfo, headerButtons, dataHandler) {
        ...
        let headerButton;
        if (this._showExpandButton || this._showBtPairButton || this._showPinButton) {
            headerButton = () => {
    ...
    _finalizeWidget(themeNode) {
        ...
        if (this._showPinButton) {
            ...
            this._isSelectedDevice =
                    this._settings.get_string('default-selected-path') === this._path;
...
export const PopupMenuWidget = GObject.registerClass({
    ...
    _init(settings, gIcon, path, alias, widgetInfo, dataHandler) {
        ...
        const box = new PopupMenuWidgetBox(settings, gIcon, path, alias,
            widgetInfo, headerButtons, dataHandler);
        this.add_child(box);
    }
});
