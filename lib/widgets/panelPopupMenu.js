...
export const PanelPopupMenu = GObject.registerClass({
    ...
    _init(settings, gIcon, path, alias, widgetInfo, dataHandler, menu) {
        super._init();
        ...
        this._icon = new St.Icon({
            ...
            gicon: gIcon(`bbm-${dataHandler.getConfig().commonIcon}-symbolic.svg`),
        });
        this._hBox.add_child(this._icon);

        this._label = new St.Label({
            text: alias, style_class: 'bbm-bt-widget',
            y_align: Clutter.ActorAlign.CENTER,
        });
        this._hBox.add_child(this._label);

        const expander =
             new St.Bin({style_class: 'popup-menu-item-expander', x_expand: true});
        ...
        const headerButtons = {pin: true, btPair: false, expand: true};

        this._popupItemBox = new PopupMenuWidgetBox(
            settings, this._gIcon, path, alias, widgetInfo, headerButtons, dataHandler);
    ...
    vfunc_key_press_event(event) {
        ...
        if (symbol  === Clutter.KEY_space && !this._isOpen) {
            ...
            return Clutter.EVENT_STOP;
                        ...
                        this._popupItemBox.expandButton.has_key_focus() && this._isOpen) {
            this._toggleSubMenuBox(false, true, true);
            return Clutter.EVENT_STOP;
        }
