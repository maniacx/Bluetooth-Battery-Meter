export const supportedIcons = [
    ...
    'input-microphone',
    'input-gaming', 'input-gaming2', 'input-gaming3',
    'input-keyboard', 'input-keyboard2', 'input-split-keyboard',
    'input-mouse', 'input-tablet', 'touchpad',
    'phone', 'phone-samsung-galaxy-s', 'phone-apple-iphone', 'phone-google-nexus-one',
    'multimedia-player', 'pda', 'camera-photo', 'camera-video', 'computer', 'video-display',
    'printer', 'scanner',  'modem', 'network-wireless',
    'wearable', 'wearable2',
    'upower-devices', 'bluetooth-gui',
];
