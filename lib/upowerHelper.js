...
async function initProxy(cancellable) {
    try {
...
async function initDeviceProxy(path, cancellable, onPropertiesChangedCallback) {
    try {
...
async function getDeviceProps(path, cancellable, requestedProps) {
    try {
...
async function getDevices(dbusProxy, cancellable, requestedProps) {
    try {
...
function watchDevices(dbusProxy, createDevicesCallback) {
