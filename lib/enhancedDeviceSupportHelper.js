...
export async function getPlayerNames() {
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Error ListNames');
        return '';
    }
}
...
export async function initMediaPlayerProxy(busname) {
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Failed to initialize proxy in mediaproxy');
        return null;
    }
}
...
export async function playPlayer(proxy) {
    try {
        if (proxy) {
            ...
            console.log('Bluetooth-Battery-Meter: Proxy not defined for playPlayer function.');
        }
    } catch {
        console.log('Bluetooth-Battery-Meter: Error adding device');
    }
}
...
export async function pausePlayer(proxy) {
    try {
        if (proxy) {
            ...
            console.log('Bluetooth-Battery-Meter: Proxy not defined for pausePlayer function.');
        }
    } catch {
        console.log('Bluetooth-Battery-Meter: Error adding device');
    }
...
export function watchServiceStatus(onAdded, onRemoved) {
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Failed to watch bus name proxy');
        return null;
    }
}
...
export function unwatchServiceStatus(watchId) {
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Failed to unwatch bus name proxy');
    }
}
...
export async function initManagerProxy() {
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Failed to initialize proxy in initManagerProxy');
        return null;
    }
}
...
export async function addDevice(proxy, devicePath, deviceType) {
    try {
        if (proxy) {
            ...
            console.log('Bluetooth-Battery-Meter: Proxy not defined for addDevice function.');
        }
    } catch {
        console.log('Bluetooth-Battery-Meter: Error adding device');
    }
...
export async function shutdownService(proxy) {
    try {
        if (proxy) {
            ...
            console.log(
                'Bluetooth-Battery-Meter: Proxy not defined for shutdownService function.');
        }
    } catch {
        console.log('Bluetooth-Battery-Meter: Error Shutting Down Script');
    }
}
...
export async function deviceProxy(path) {
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Failed to initialize proxy in deviceProxy');
        return null;
    }
}
...
export async function requestStatus(proxy, information) {
    ...
    try {
        ...
        console.log('Bluetooth-Battery-Meter: Errored during requestStatus');
    }
...
export async function setDeviceCommand(proxy, command) {
    try {
        if (proxy) {
            ...
            console.log(
                'Bluetooth-Battery-Meter: Proxy not defined for setDeviceCommand function.');
        }
    } catch {
        console.log('Bluetooth-Battery-Meter: Errored during setDeviceCommand');
    }
}
