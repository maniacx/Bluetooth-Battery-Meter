...
export const BluetoothBatteryMeter = GObject.registerClass({
    ...
    _startBluetoothToggle() {
        ...
        this.pixelBudsEnabled = this.settings.get_boolean('enable-pixel-buds-device');
        ...
        this.settings.connectObject(
            ...
            'changed::enable-pixel-buds-device', () => {
                this.pixelBudsEnabled = this.settings.get_boolean('enable-pixel-buds-device');
                this._setEnhancedDeviceMode();
                this._onActiveChanged();
            },
    ...
    _setEnhancedDeviceMode() {
        ...
        const enableEnhancedDeviceMode = this.airpodsEnabled || this.sonyEnabled ||
            this.galaxyBudsEnabled || this.nothingBudsEnabled || this.pixelBudsEnabled || this.googleBudsEnabled || this.gattBasEnabled;
