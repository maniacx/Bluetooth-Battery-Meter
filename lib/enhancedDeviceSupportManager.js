...
import {PixelBudsDevice, isPixelBuds, DeviceTypePixelBudsStr} from './devices/pixelBuds/pixelBudsDevice.js';
                ...
                if (deviceProps.type === DeviceTypeAirpods) {
                    ...
                    deviceProps.enhancedDevice =
                        new NothingBudsDevice(this._settings, path, deviceProps.alias,
                            this._extPath, this._profileManager,
                            this.updateDeviceMapCb.bind(this));
                } else if (deviceProps.type === DeviceTypePixelBudsStr) {
                    deviceProps.enhancedDevice =
                        new PixelBudsDevice(this._settings, path, deviceProps.alias,
                            this._extPath, this._profileManager,
                            this.updateDeviceMapCb.bind(this),
