...
// Release builds retain only errors and the startup version in the file log.
...
export function createLogger(tag) {
    return {
        info: LOG_INFO
            ...
            : () => {},
        // This narrow release marker allows installed build verification without debug logs.
        release: (...args) => WriteLogLine('REL', `[${tag}] ${args.join(' ')}`),
        error: (err, msg = '') => {
