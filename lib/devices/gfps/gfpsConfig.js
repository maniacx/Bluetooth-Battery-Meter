...
export const PixelBudsUUID = 'df21fe2c-2515-4fdb-8886-f12c4d67927c';
export const DeviceTypePixelBuds = 'pixelBuds';
...
export const PixelBudsModelList = [
    {
        modelId: 'PixelBudsPro',
        alias: 'Pixel Buds Pro',
        budsIcon: 'earbuds-stem3',
        case: 'case-oval', // Or fallback to standard case icon
        batteryLR: true,
        batteryCase: true,
    }
];
