...
function isSony(bluezDeviceProxy, uuid) {
...
export function isSonyV1(bluezDeviceProxy) {
    return isSony(bluezDeviceProxy, SonyUUIDv1);
}

export function isSonyV2(bluezDeviceProxy) {
    return isSony(bluezDeviceProxy, SonyUUIDv2);
}
...
*/
        ...
        if (this._speakToChatEnabledSupported) {
            this._config.toggle2Title = _('Speak to Chat');
    ...
    _initializeProfile(modelData) {
        try {
            ...
            if (fd === -1) {
                ...
                const type =  this._usesProtocolV2 ? 'sonyV2' : 'sonyV1';
                const uuid =  this._usesProtocolV2 ? SonyUUIDv2 : SonyUUIDv1;

                this._profileManager.registerProfile(type, uuid);
            } else {
    ...
    _addPropsToSettings(pathsString) {
        pathsString.push(this._defaultsDeviceSettings);
        this._settings.set_strv('sony-list', pathsString.map(JSON.stringify));
    }
    ...
    _checkProperties(devices) {
        ...
        if (changed) {
            this._settings.set_strv('sony-list',
    ...
    _updateGsettingsProps() {
        ...
        if (this._speakToChatConfigSupported) {
            ...
            if (this._speak2ChatSensitivity === undefined)
        ...
        if (this._speakToChatConfigSupported) {
            ...
            if (this._speak2ChatTimeout === undefined)
        ...
        if (this._listeningModeSupported) {
            ...
            if (this._bgmDistance === undefined)
        ...
        if (this._buttonModesLeftRight) {
            ...
            if (this._btnLeft === undefined)
                this._btnLeft = btnLeft;
            if (this._btnRight === undefined)
        ...
        if (this._ambientSoundControlButtonMode) {
            ...
            if (this._ambientButtonMode === undefined)
        ...
        if (this._voiceNotificationsVolumeSupported) {
            ...
            if (this._voiceVolume === undefined)
        ...
        if (this._pauseWhenTakenOffSupported) {
            ...
            if (this._pauseWhenTakenOff === undefined)
        ...
        if (this._automaticPowerOffWhenTakenOffSupported) {
            ...
            if (this._autoPowerOff === undefined)
        ...
        if (this._automaticPowerOffByTimeSupported) {
            ...
            if (this._autoPowerOffTime === undefined)
    ...
    _startConfiguration(battInfo) {
        ...
        if (pathsString.length === 0 ||
            ...
            this._addPropsToSettings(pathsString);
        else
    ...
    _setSpeakToChatConfig() {
        ...
        if (this._speak2ChatSensitivity !== undefined && this._speak2ChatTimeout !== undefined) {
            this._sonySocket.setSpeakToChatConfig(
                this._speak2ChatSensitivity, this._speak2ChatTimeout);
        }
    }
    ...
    updateBgmMode(enable, distance) {
        ...
        if (enable)
            this._bgmMode = ListeningMode.BGM;
        else
            this._bgmMode = ListeningMode.STANDARD;

        this._bgmDistance = distance;

        if (this._settingsItems) {
            this._settingsItems['bgm-mode'] = this._bgmMode;
            this._settingsItems['bgm-distance'] = this._bgmDistance;
            this._updateGsettings();
        }
    }
    ...
    updateCinemaMode(enable) {
        if (!this._listeningModeSupported && !enable)
            return;
        this._bgmMode = ListeningMode.CINEMA;
        if (this._settingsItems) {
            this._settingsItems['bgm-mode'] = this._bgmMode;
            this._updateGsettings();
        }
    ...
    _setBgmMode() {
        ...
        if (this._bgmMode !== undefined && this._bgmDistance !== undefined)
    ...
    _setEqualizerPreset() {
        if (!this._equalizerSixBandsSupported || this._eqPreset === undefined || this._protocolV2)
            return;
    ...
    updateButtonModesLeftRight(leftMode, rightMode) {
        ...
        if (this._settingsItems) {
            this._settingsItems['btn-left'] = this._btnLeft;
            this._settingsItems['btn-right'] = this._btnRight;
            this._updateGsettings();
        }
    }
    ...
    _setButtonModes() {
        ...
        if (this._btnLeft !== undefined && this._btnRight !== undefined)
    ...
    _setAutoPowerOff() {
        if (!this._automaticPowerOffWhenTakenOffSupported && this._autoPowerOff !== undefined)
            return;

        if (this._automaticPowerOffByTimeSupported && this._autoPowerOffTime !== undefined)
            return;
