...
import {
    MessageType, booleanFromByte, isValidByte, PayloadTypeV2T1 as PTV2T1, FunctionTypeV2T1,
    PayloadTypeV2T2 as PTV2T2, ValueType, BatteryType, AudioCodec, DseeType,
    BatteryStatus, AmbientSoundMode, AutoAsmSensitivity, AsmType, Speak2ChatSensitivity,
    Speak2ChatTimeout, EqualizerPreset, ListeningMode, BgmDistance, AutoPowerOffState,
    AutoPowerOffTime, AmbientButtonMode, ButtonModes, EqInquiryType
} from './sonyConfig.js';
...
export const SonySocketV2 = GObject.registerClass({
    ...
    _init(devicePath, fd, modelData, callbacks) {
        ...
        this._log = createLogger('SonySocketV2');
