...
import {
    MessageType, booleanFromByte, isValidByte, PayloadTypeV1T1 as PTV1T1, ValueType,
    FunctionTypeV1T1, BatteryType, AudioCodec, DseeType, AmbientSoundMode, Speak2ChatSensitivity,
    Speak2ChatTimeout, EqualizerPreset, AutoPowerOffState, AutoPowerOffTime
} from './sonyConfig.js';
...
export const SonySocketV1 = GObject.registerClass({
    ...
    _init(devicePath, fd, modelData, callbacks) {
        ...
        this._log = createLogger('SonySocketV1');
        this._log.info('SonySocketV1 init');
