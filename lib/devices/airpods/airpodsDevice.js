...
import {buds2to1BatteryLevel} from '../deviceUtils.js';
...
export const AirpodsDevice = GObject.registerClass({
    ...
    _updateMediaControllerConfigs() {
        ...
        if (this._lpVolume === undefined)
            this._lpVolume = this._settingsItems['lp-value'];

        if (this._lpVolume !== this._settingsItems['lp-value']) {
            this._lpVolume = this._settingsItems['lp-value'];
