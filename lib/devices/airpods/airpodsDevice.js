...
export const AirpodsDevice = GObject.registerClass({
    ...
    _init(settings, devicePath, alias, extPath, updateDeviceMapCb, profileManager) {
        super._init();
        const now = Date.now();
    ...
    _initialize() {
        ...
        if (match) {
            ...
            if (this._ancSupported) {
                this._config.toggle1Title = _('Active Noise Cancellation');
                ...
                this._config.toggle1Button2Name = _('On');
