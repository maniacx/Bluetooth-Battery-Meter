...
export const DeviceWidgetManager = GObject.registerClass({
    GTypeName: 'BluetoothBatteryMeter_DeviceWidgetManager',
    Properties: {
    ...
    update() {
        if (this._toggle.deviceList.has(this._path)) {
            ...
            if (!this._type && this._deviceIcon !== props.icon) {
                ...
                this._config.battery1Icon = this._deviceIcon;
                this._config.commonIcon = this._deviceIcon;
                this._config.albumArtIcon = this._deviceIcon;
    ...
    _checkLateBluezBatteryReporting() {
        ...
        this.connectObject(
            'notify::batteryPercentage', () => {
                ...
                this._startSingleModeDataHandler();
            },
            this
        );
        this._startSingleModeDataHandler();
