...
**Bluetooth Indicator**
<br>
<img src="../../assets/images/preferences/indicator/indicator.png" width="40%">

**Indicator Preferences**
<br>
<img src="../../assets/images/preferences/indicator/indicator-prefs.png" width="100%">
...
<br>
<img src="../../assets/images/preferences/indicator/indicator-text.png" width="50%">
<br>
<br>
...
<br>
<br>
<img src="../../assets/images/preferences/indicator/status-normal.png" width="20%">
<br>

This setting provides three options:
- **Default Behavior:** The icon will follow its original behavior as intended by GNOME.
<img src="../../assets/images/preferences/indicator/status-indicator.png" width="40%">
<br>
- **Hide Always:** The Bluetooth Connection Status Indicator icon will always be hidden.
    <img src="../../assets/images/preferences/indicator/status-hidden.png" width="40%">
    <br>
...
<br>
<br>
<img src="../../assets/images/preferences/indicator/settings-indicator-level-type.png" width="100%">
<br>
...
<img src="../../assets/images/preferences/indicator/level-bar.png" width="10%">


**Battery Level Dots Mode**

<img src="../../assets/images/preferences/indicator/level-50-dot.png" width="10%">

| Symbolic | Battery Level |
|:-:|:-:|
| <img src="../../assets/images/preferences/indicator/level-100-dot.png" width="15%"> | Approx. Fully Charge<br>Battery level: 100 - 76%  |
| <img src="../../assets/images/preferences/indicator/level-75-dot.png" width="15%"> | Battery level: 75-51% |
| <img src="../../assets/images/preferences/indicator/level-50-dot.png" width="15%"> | Battery level: 50-26% |
| <img src="../../assets/images/preferences/indicator/level-25-dot.png" width="15%"> | Battery level: 25-20% |
| <img src="../../assets/images/preferences/indicator/level-20-dot.png" width="15%"> | Warning! Below 20%<br>Battery level: 20-0% |

---
## **Indicator: Battery Level Color Scheme**
<br>
<img src="../../assets/images/preferences/indicator/settings-indicator-level-scheme.png" width="100%">
<br>
...
<img src="../../assets/images/preferences/indicator/level-bar.png" width="10%">
<img src="../../assets/images/preferences/indicator/color-20-bar.png" width="10%">
<img src="../../assets/images/preferences/indicator/level-50-dot.png" width="10%">
<img src="../../assets/images/preferences/indicator/level-20-dot.png" width="10%">

- **Color:** 
  The color of the bar/dot will be **green** when the battery percentage is above 20%, and **orange** when it is 20% or lower.

<img src="../../assets/images/preferences/indicator/color-50-bar.png" width="10%">
<img src="../../assets/images/preferences/indicator/color-20-bar.png" width="10%">
<img src="../../assets/images/preferences/indicator/color-50-dot.png" width="10%">
<img src="../../assets/images/preferences/indicator/level-20-dot.png" width="10%">

- **Customize:**
  Allows you to define custom colors for different battery level ranges.
  
<img src="../../assets/images/preferences/indicator/settings-indicator-level-customize.png" width="100%">
