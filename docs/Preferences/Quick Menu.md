...
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-battery-text-icon.png' | relative_url }}" width="45%">
...
---
## Modify Bluetooth device menu

{: .important-title }
> Introduced in Version 43

<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-modify-qsettings.png' | relative_url }}" width="70%">

Added an option to leave the QuickSettings menu unchanged. Enabling it will reveal additional options for customizing the quick settings menu.

<img src="{{ 'assets/images/preferences/quick-menu/qc-unmodified.png' | relative_url }}" width="45%">
...
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-submenu-prefs.png' | relative_url }}" width="70%">
...
### **Disabled**
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-battery-icon-text.png' | relative_url }}" width="45%">
<br>
<br>
### **Enabled**
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-submenu.png' | relative_url }}" width="45%">
<br>
<br>
...
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-show-battery-icon-prefs.png' | relative_url }}" width="70%">

Shows a battery icon indicating the charge level of supported Bluetooth devices in the Bluetooth quick menu.

<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-battery-icon.png' | relative_url }}" width="45%">

---

## Show Bluetooth device battery percentage
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-show-battery-text-prefs.png' | relative_url }}" width="70%">

Shows the battery percentage of supported Bluetooth devices as text in the Bluetooth quick menu.
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-battery-text.png' | relative_url }}" width="45%">

---

## Display battery level icon before text
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-swap-icon-text-prefs.png' | relative_url }}" width="70%">
...
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-sort.png' | relative_url }}" width="70%">
<br>
 ...
 * S - Selfie
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-sort-disabled.png' | relative_url }}" width="45%">
<br>
...
<br>
<img src="{{ 'assets/images/preferences/quick-menu/qc-sort-enabled.png' | relative_url }}" width="45%">
<br>
