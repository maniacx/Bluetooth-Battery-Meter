...
<img src="{{ 'assets/images/translation/crowdin-guide/join.png' | relative_url }}" width="100%">
...
<img src="{{ 'assets/images/translation/crowdin-guide/choose-language.png' | relative_url }}" width="100%">

---
### 3. Click on `Translate All`
<img src="{{ 'assets/images/translation/crowdin-guide/translate-all.png' | relative_url }}" width="100%">
...
<img src="{{ 'assets/images/translation/crowdin-guide/translate-board.png' | relative_url }}" width="100%">

---
### 7. Click on the 3-dot menu and select `Download`
<img src="{{ 'assets/images/translation/crowdin-guide/download.png' | relative_url }}" width="100%">
