...
<img src="{{ 'assets/images/translation/pull-request-guide/fork.png' | relative_url }}" width="100%">

---
### 3. Uncheck `Copy the main branch only` and click `Create Fork`.
<img src="{{ 'assets/images/translation/pull-request-guide/create-a-fork.png' | relative_url }}" width="100%">
...
<img src="{{ 'assets/images/translation/pull-request-guide/create-branch.png' | relative_url }}" width="100%">

---
### 7. Navigate to the `po` folder, click `Add file`, and then `Upload files`.
<img src="{{ 'assets/images/translation/pull-request-guide/upload-file.png' | relative_url }}" width="100%">
...
<img src="{{ 'assets/images/translation/pull-request-guide/file-commit.png' | relative_url }}" width="100%">
...
<img src="{{ 'assets/images/translation/pull-request-guide/open-pr.png' | relative_url }}" width="100%">
